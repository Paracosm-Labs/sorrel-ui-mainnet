import { StableCoinType, USDCAddress } from "../utils/stableCoins";
...
const usdcContract_ = new USDCContract(USDCAddress, StableCoinType.USDC);

let usdcContractInitialized = null;

export const usdcContract = async () => {
  if (!usdcContractInitialized) {
    console.log("initializing USDT contract");
    usdcContractInitialized = await usdcContract_.init();
  }
  return usdcContractInitialized;
};
